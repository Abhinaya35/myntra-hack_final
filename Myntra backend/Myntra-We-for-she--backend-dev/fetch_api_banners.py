...
API_BASE = f"{settings.API_V1_STR}" if hasattr(settings, 'API_V1_STR') else ''
BASE_URL = f"http://localhost:{settings.PORT}{settings.API_V1_STR}" if hasattr(settings, 'PORT') else 'http://localhost:8000/api/v1'
