...
class UserDB(BaseModel):
    ...
    phone: Optional[str] = Field(default=None, description="User's login phone number")
    gender: Optional[str] = Field(default=None, description="User's gender")
    date_of_birth: Optional[str] = Field(default=None, alias="dateOfBirth", description="User's date of birth")
